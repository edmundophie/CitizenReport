		...
		<table class="table table-striped table-hover">
			...
			<tr>
				...
				<td>
					...
					<a href="{{URL::to('edit-skpd/'.$skpd['id_user'])}}" ><span class="glyphicon glyphicon-pencil text-success"> </span></a> 
					<a href="{{URL::to('delete-skpd/'.$skpd->id_user)}}" onclick="return confirm('Anda yakin ingin menghapus SKPD ini?')"> <span class="glyphicon glyphicon-remove text-danger"> </span></a>
					</div>
				</td>
			</tr>			
			@endforeach	
